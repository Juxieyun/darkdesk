...
###
 ...
 # @LastEditTime: 2024-11-22 08:42:18
...
build_arm64(){
    ...
    cp $WORKDIR/target/aarch64-linux-android/release/liblibdarkdesk.so $WORKDIR/flutter/android/app/src/main/jniLibs/arm64-v8a/libdarkdesk.so
    cd $CWD
}
