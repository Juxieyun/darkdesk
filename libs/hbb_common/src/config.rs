...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("DarkDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["23.94.92.178"];
pub const PUBLIC_RS_PUB_KEY: &str = "1Bim36xqjFI15TvsfZNWC4p8m7mbFz335s9X0xkdIs4=";
